...
# 2. How many rows are in mtcars? How many colums?
glimpse(mtcars)
...
# 5. What happens if you make a scatterplot of class versus drv? Why is the plot
# not useful?
ggplot(data = mpg) + 
...
# variables, so the scatterplot graphic doesn't show much.
